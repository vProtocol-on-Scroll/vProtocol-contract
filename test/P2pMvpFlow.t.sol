...
//         address one = _lF.deployVault(tokens[0], "Five USDC", "vUSDC");
//         address two = _lF.deployVault(tokens[1], "Five WETH", "vWETH");
//         address three = _lF.deployVault(tokens[2], "Five WBTC", "vWBTC");
...
//         emit IERC20.Transfer(address(diamond), user1, 250e18);
//         pool.withdraw(address(weth), 250e18, true, false);
//         assertEq(weth.balanceOf(address(diamond)), 250e18);
//     }
